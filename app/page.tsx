      ...
      <main className="flex-1">
        <section className="bg-gradient-to-b from-white to-gray-50 py-20">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
              Connect with your clients <span className="text-primary">effortlessly</span>
            </h1>
            <p className="mx-auto mt-6 max-w-2xl text-lg text-gray-600">
              The ultimate scheduling tool for advisors. Streamline your client meetings and integrate with your
              existing tools.
            </p>
            <div className="mt-10">
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <h2 className="text-center text-3xl font-bold tracking-tight text-gray-900 mb-12">Key Features</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="flex flex-col items-center p-6 bg-white rounded-lg shadow-sm">
                ...
                <p className="text-center text-gray-600">
                  Seamlessly integrate with Hubspot to keep your client information up to date.
                </p>
              </div>
              <div className="flex flex-col items-center p-6 bg-white rounded-lg shadow-sm">
                ...
                <p className="text-center text-gray-600">
                  Create custom scheduling links with advanced settings and personalized questions.
                </p>
              </div>
            </div>
          </div>
